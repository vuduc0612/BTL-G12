<%-- 
    Document   : booknow
    Created on : Nov 17, 2023, 11:45:09 PM
    Author     : huuduc
--%>
                ...
                <div class="row">
                        ...
                        <form action="/hotel/booking" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <div style="position: relative;">
                                        <span class="fa fa-calendar icon" style="position: absolute; right: 10px; top: 10px;"></span>
                                        <input type='text' name="departure_date" class="form-control" id='departure_date' />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="room">Họ và tên</label>
                                    <input type="name" name="name" id="name" class="form-control ">
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="room">Số điện thoại</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="submit" value="Reserve Now With <%= room.getPrice()%>" class="btn btn-primary">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="media d-block room mb-0">
                            <figure>
                                <%String url = room.getImg();%>
                                <img src="<%= url%>" alt="Generic placeholder image" class="img-fluid">
                                <div class="overlap-text">
                                    <span>
                                        <%int star = room.getRate();
                            ...
                            <div class="media-body">
                                <h3 class="mt-0"><%= room.getType()%> Room</h3>
                                <ul class="room-specs">
                                    <li><span class="ion-ios-people-outline"></span><%= room.getGuest()%></li>
                                    <li><span class="ion-ios-crop"></span><%= room.getSquare()%> <sup>2</sup></li>
                                </ul>
                                <p><%= room.getDes()%></p>
                                <p class="btn btn-primary btn-sm">Từ <%= room.getPrice()%> VND</p>
                            </div>
                        </div>
                    </div>
                </div>
